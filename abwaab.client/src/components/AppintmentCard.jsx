    ...
    <div className="w-full mx-auto p-0">
      ...
      {day.appointments.map((t) => (
        <div key={t.appointmentId} className="  flex items-center gap-5 my-3">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl w-full p-5 flex items-center gap-5">
            ...
            <div className="flex-1 space-y-2">
              <LabelTag
                classes="rounded-2xl bg-sky-100 px-3 text-sm"
                label={t.arabicAppointmentState}
                key={t.appointmentId}
              />
