    ...
    >
      ...
      <DialogContent className="px-2 py-0 flex flex-col justify-between">
        ...
        <Box className="relative my-3 flex-1 flex items-center justify-center min-h-[350px] md:min-h-[480px] bg-slate-100 rounded-2xl overflow-hidden">
          ...
          <IconButton
            onClick={handlePrev}
            className="!absolute left-4 top-1/2 -translate-y-1/2 !bg-white hover:bg-white !text-navy-600 shadow-md p-2"
          >
          ...
          <IconButton
            onClick={handleNext}
            className="!absolute right-4 top-1/2 -translate-y-1/2 !bg-white hover:bg-white !text-navy-600 shadow-md p-2"
          >
          ...
          {mediaItems.map((item, index) => {
            ...
            return (
              <Box
                ...
                className={`min-w-[200px] mx-1 relative h-20 md:h-24 rounded-xl overflow-hidden cursor-pointer transition-all ${
                  isSelected
