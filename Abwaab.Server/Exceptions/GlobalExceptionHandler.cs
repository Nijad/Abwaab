...
namespace Abwaab.Server.Exceptions
{
    ...
    public sealed class GlobalExceptionHandler(IProblemDetailsService problemDetailsService) : IExceptionHandler
    {
        public async ValueTask<bool> TryHandleAsync(HttpContext httpContext, Exception exception, CancellationToken cancellationToken)
        {
            ...
            {
                //NoVerifiedPhoneException ex => new CustomProblemDetails
                //{
                ...
                //},
                //NoRegisterdPhoneException ex => new CustomProblemDetails
                //{
                //    Status = ex.ReturnToUser ? 
                //        StatusCodes.Status412PreconditionFailed :
                //        StatusCodes.Status500InternalServerError,
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //AlreadyUnsubscribeNotificationWayException ex => new CustomProblemDetails
                //{
                //    Status = ex.ReturnToUser ? 
                //        StatusCodes.Status412PreconditionFailed :
                //        StatusCodes.Status500InternalServerError,
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //NoVerifiedEmailException ex => new CustomProblemDetails
                //{
                //    Status = ex.ReturnToUser ? 
                //        StatusCodes.Status412PreconditionFailed :
                //        StatusCodes.Status500InternalServerError,
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //NoRegisterdEmailException ex => new CustomProblemDetails
                //{
                //    Status = ex.ReturnToUser ? 
                //        StatusCodes.Status412PreconditionFailed :
                //        StatusCodes.Status500InternalServerError,
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //RegistrationFailedException ex => new CustomProblemDetails
                //{
                //    Status = ex.ReturnToUser ? 
                //        StatusCodes.Status400BadRequest ://todo correct error status code
                //        StatusCodes.Status500InternalServerError,
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //ExceededAllowedPropertyNumberException ex => new CustomProblemDetails
                //{
                ...
                //    ErrorCode = ex.ErrorCode
                //},
                //FailedCancellationUserPlanException ex => new CustomProblemDetails
                //{
                //    Status = StatusCodes.Status412PreconditionFailed,
                ...
                ValidationException ex => new ValidationProblemDetails(ex.Errors.GroupBy(g => g.PropertyName).ToDictionary(g => g.Key, g => g.Select(e => e.ErrorMessage).ToArray()))
                {
                    Status = StatusCodes.Status400BadRequest,
                    Title = "فشل التحقق",
                    Detail = "حدث خطأ واحد أو أكثر في التحقق من الصحة."
                },
                CusotomException ex => new CustomProblemDetails
                {
                    Status = ex.ReturnToUser ?
                        StatusCodes.Status412PreconditionFailed :
                        StatusCodes.Status500InternalServerError,
